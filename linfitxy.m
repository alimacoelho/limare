 function [ p, sp ] = linfitxy( xdatain, ydatain, xerrin, yerrin, varargin)
...
nsigma=1;
verbosity=1;
plotting=false;%alterado
plothull=false;%alterado
onlyplot=false;%alterado
fitresultongraph=false;%alterado
...
% some inits
if matlabmode
  options = optimset('MaxFunEvals',10000, 'MaxIter',10^8,'Display','on'); % to avoid optimset warnings (?)
end
